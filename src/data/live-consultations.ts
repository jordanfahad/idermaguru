...
export const liveConsultationOne: LiveConsultationConfig = {
  ...
  subtitle:
    "A curated OTC skincare consultation: a simple, safety-checked routine with products matched from the store's catalog.",
  ...
  products: [
    ...
    },
    {
      ...
      why: "Daily morning SPF that helps protect brightening and texture results from sun-related setbacks.",
    ...
    },
    {
      ...
      why: "A light hydration layer for shoppers who want a dewy finish, with no harsh or prescription-style actives.",
      safety: "Skip if the user reports allergy to listed ingredients.",
      trust: "Partner placement from an approved retail catalog, shown with sponsored disclosure.",
      priority: 65,
    ...
    },
    {
      ...
      why: "A low-cost option for mild occasional blemishes — gentle, non-prescription spot support.",
